...
Gatsby.js V4 starter template based on Readonly by HTML5 UP

For an overview of the project structure please refer to the [Gatsby documentation - Building with Components](https://www.gatsbyjs.org/docs/building-with-components/).

![Screenshot](./src/assets/img/readonly.jpg)

Check online preview [here](https://anubhavsrivastava.github.io/gatsby-starter-readonly/)
...
```sh
gatsby new <site-name> https://github.com/anubhavsrivastava/gatsby-starter-readonly
```
